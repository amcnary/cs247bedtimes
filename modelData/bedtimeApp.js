...
(function() {
   ...
   var activity1 = {liked: false, name: 'Coloring', rating: 3.0, description: 'Get out the markers, crayons and colored pencils and make a masterpiece! Find a coloring book to decorate, or draw your own creations. ',link:'',file_name: 'drawing_transparent.png', activity_level: 'low', tag: 'creative', duration: 15, id: 1};
   ...
   var activity19 = {liked: false, name: 'Family Workout', description:'Get moving! Grab a jumprope, hop on the trampoline, jump in the pool or go on a bike ride!',link:'http://www.huffingtonpost.com/2014/08/05/mom-exercises-with-kids-lauren-rodgers_n_5648970.html',rating: 3.0, file_name: 'work_out.jpg', activity_level: 'high', tag: 'physical', duration: 15, id: 19};
